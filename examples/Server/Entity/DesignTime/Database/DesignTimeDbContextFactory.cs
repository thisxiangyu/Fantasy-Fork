...
namespace Fantasy.Database
{
    ...
    /// Win平台, 在PowerShell输入 : 
    /// dotnet ef migrations add MigrationTest2 --project "F:\Unity\Fantasy\Fantasy-Fork\Fantasy.Net\Fantasy.Net" --startup-project "F:\Unity\Fantasy\Fantasy-Fork\examples\Server\Entity" --context PgSession
    ...
    public class DesignTimeDbContextFactory : IDesignTimeDbContextFactory<PgSession>
    {
        ...
        public PgSession CreateDbContext(string[] args)
        {
            ...
            var configText = File.ReadAllText("../../../examples/Server/Main/Fantasy.config", Encoding.UTF8);
            ...
            Log.Info("PgSession 中识别到的实体类型：");
            foreach (var entityType in entityTypes)
            {
                Log.Info($"- {entityType.ClrType.Name}");
            }
